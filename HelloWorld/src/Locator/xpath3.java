...
public class xpath3 
{
	...
	public static void main(String[] args) 
	{
		...
		driver.findElement(By.xpath("//input[@name='pass']")).sendKeys("abc");     // find Password field and put data as abc
		
		driver.findElement(By.xpath("//button[@name='login']")).click();           // find login button and click to proceed
