...

{
	...
	public static void main(String[] args) 
	{
		...
		driver.findElement(By.xpath("//input[@id='email']")).sendKeys("pritesh254@gmail.com");   	// find username field and put data as xyz
		
		driver.findElement(By.xpath("//input[@name='pass']")).sendKeys("xyscd");     // find Password field and put data as abc
		
		driver.findElement(By.xpath("//button[@name='login']")).click();  
		
		
		
		// find login button and click to proceed
